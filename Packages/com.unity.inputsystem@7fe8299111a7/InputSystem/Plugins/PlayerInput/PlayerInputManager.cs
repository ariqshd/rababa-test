...
namespace UnityEngine.InputSystem
{
    ...
    public class PlayerInputManager : MonoBehaviour
    {
        ...
        protected virtual void JoinPlayerFromActionIfNotAlreadyJoined(InputAction.CallbackContext context)
        {
            if (!CheckIfPlayerCanJoin())
                return;
        ...
        protected virtual void OnUnpairedDeviceUsed(InputControl control, InputEventPtr eventPtr)
        {
            if (!m_AllowJoining)
                return;
